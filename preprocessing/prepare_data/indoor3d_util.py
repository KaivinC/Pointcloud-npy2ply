...
g_class2color = {'floor': [152, 223, 138], 
                 'wall': [152, 223, 138],
                 'cabinet': [152, 223, 138], 
                 'bed': [152, 223, 138], 
                 'chair': [152, 223, 138], 
                 ...
                 'door': [152, 223, 138], 
                 'window': [152, 223, 138], 
                 'bookshelf': [152, 223, 138], 
                 'picture': [152, 223, 138], 
                 'counter': [152, 223, 138], 
                 'desk': [152, 223, 138], 
                 'curtain': [152, 223, 138], 
                 'refrigerator': [152, 223, 138], 
                 'bathtub': [152, 223, 138], 
                 'shower curtain': [152, 223, 138], 
                 'toilet': [152, 223, 138], 
                 'sink': [152, 223, 138], 
                 'otherprop': [152, 223, 138]
                 }
...
def room2blocks_plus_normalized(data_label, num_point, block_size, stride,
    ...
    """
    data = data_label[:,0:6]
    #because te data already normalized
    data[:,3:6] /= 255.0
    label = data_label[:,-1].astype(np.uint8)
